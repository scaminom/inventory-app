...
ActiveRecord::Schema[7.1].define(version: 20_231_223_173_707) do
  ...
  create_table 'activities', force: :cascade do |t|
    ...
    t.string 'actor_type'
    t.bigint 'actor_id'
    t.index %w[actor_type actor_id], name: 'index_activities_on_actor'
  ...
  create_table 'assets', force: :cascade do |t|
    ...
    t.index %w[custodian_type custodian_id], name: 'index_assets_on_custodian'
  ...
  create_table 'suggestions', force: :cascade do |t|
    ...
    t.index %w[suggestor_type suggestor_id], name: 'index_suggestions_on_suggestor'
  end
